...
class Solicitud(models.Model):
    ...
    nss = models.CharField(blank=True, null=True, max_length=15)
    ...
    disponibilidad = models.CharField(null=True, max_length=10, choices=(
        ('Part-Time', 'Part-Time'),
        ('Full-Time', 'Full-Time'),
    ))
    ...
    # education
    escSecundaria = models.CharField(blank=True, null=True, max_length=200, db_column='esc_secundaria')
    secDireccion = models.CharField(blank=True, null=True, max_length=200, db_column='sec_direccion')
    ...
    secDiploma = models.CharField(blank=True, null=True, max_length=100, db_column='sec_diploma')

    universidad = models.CharField(blank=True, null=True, max_length=200)
    uniDireccion = models.CharField(blank=True, null=True, max_length=200, db_column='uni_direccion')
    ...
    uniDiploma = models.CharField(blank=True, null=True, max_length=100, db_column='uni_diploma')

    otraEscuela = models.CharField(blank=True, null=True, max_length=200, db_column='otra_escuela')
    otraEscDireccion = models.CharField(blank=True, null=True, max_length=200, db_column='otra_esc_direccion')
    # references
    ...
    refUnoCompania = models.CharField(blank=True, null=True, max_length=100, db_column='ref1_compania')
    refUnoTelefono = models.CharField(max_length=15, db_column='ref1_telefono')

    refDosNombreCompleto = models.CharField(blank=True, null=True, max_length=200, db_column='ref2_nombre_completo')
    refDosRelacion = models.CharField(blank=True, null=True, max_length=100, db_column='ref2_relacion')
    refDosCompania = models.CharField(blank=True, null=True, max_length=100, db_column='ref2_compania')
    refDosTelefono = models.CharField(blank=True, null=True, max_length=15, db_column='ref2_telefono')
    # previous employment
    peUnoCompania = models.CharField(blank=True, null=True, max_length=200, db_column='pe1_compania')
    peUnoTelefono = models.CharField(blank=True, null=True, max_length=15, db_column='pe1_telefono')
    peUnoDireccion = models.CharField(blank=True, null=True, max_length=200, db_column='pe1_direccion')
    peUnoSupervisor = models.CharField(blank=True, null=True, max_length=150, db_column='pe1_supervisor')
    peUnoPuesto = models.CharField(blank=True, null=True, max_length=150, db_column='pe1_puesto')
    ...
    peUnoResponsabilidades = models.TextField(blank=True, null=True, db_column='pe1_responsabilidades')
    peUnoDesde = models.DateField(null=True, db_column='pe1_desde')
    peUnoHasta = models.DateField(null=True, db_column='pe1_hasta')
    peUnoRazonesIrse = models.TextField(blank=True, null=True, db_column='pe1_razones_irse')
    peUnoPedirReferencia = models.BooleanField(default=False, db_column='pe1_pedir_referencia')

    peDosCompania = models.CharField(blank=True, null=True, max_length=200, db_column='pe2_compania')
    peDosTelefono = models.CharField(blank=True, null=True, max_length=15, db_column='pe2_telefono')
    peDosDireccion = models.CharField(blank=True, null=True, max_length=200, db_column='pe2_direccion')
    peDosSupervisor = models.CharField(blank=True, null=True, max_length=150, db_column='pe2_supervisor')
    peDosPuesto = models.CharField(blank=True, null=True, max_length=150, db_column='pe2_puesto')
    ...
    peDosResponsabilidades = models.TextField(blank=True, null=True,  db_column='pe2_responsabilidades')
    peDosDesde = models.DateField(null=True, db_column='pe2_desde')
    peDosHasta = models.DateField(null=True, db_column='pe2_hasta')
    peDosRazonesIrse = models.TextField(blank=True, null=True, db_column='pe2_razones_irse')
    ...
    isHizoServMili = models.BooleanField(default=False, db_column='is_hizo_serv_militar')
    # administrativos
